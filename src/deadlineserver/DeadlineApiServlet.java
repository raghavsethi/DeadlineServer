...
public class DeadlineApiServlet extends HttpServlet{

	private static final Logger log = Logger.getLogger(DeadlineApiServlet.class.getName());
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException
	{
		...
		if(regId!=null){
			...
			oldUser = ofy.query(DUser.class).filter("userId",userId).get();
